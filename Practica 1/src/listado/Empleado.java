...
public class Empleado {
    ...
    /**
     * Constructor de la clase
     * @param linea String donde tenemos el DNI, nombre, apellidos y correo de un empleado
     */
    public Empleado(String linea){
        Pattern patron = Pattern.compile(",");

        List<String> informacionEmpleado = patron.splitAsStream(linea).collect(Collectors.toList());

        dni = informacionEmpleado.get(0);
        nombre = informacionEmpleado.get(1);
        apellidos = informacionEmpleado.get(2);
        correo = informacionEmpleado.get(3);
