...
import balanceoCadenasParentesis.chequearBalance

class balanceoCadenasParentesisTest extends FunSuite {
  ...
  // Prueba 2
  test("chequear balance: 'Te lo dije ...' no esta balanceada") {
